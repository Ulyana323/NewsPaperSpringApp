...
public class NewsServiceTest {
    ...
    void ShowNewsWithPageNot0()
    {
        ...
        given(newsRepo.findAll(PageRequest.of(1, 3, Sort.by("createdAt").descending())))
                .willReturn(Arrays.asList(news3,news2,news1));
        //when
    ...
    {
        //given
        Comment com1 =new Comment(1,new Date(),"text",new Person(1,"o","o","o","o",Collections.emptyList()),new News());
        Comment com2 =new Comment(2,new Date(),"txt",new Person(2,"p","o","o","o",Collections.emptyList()),new News());
